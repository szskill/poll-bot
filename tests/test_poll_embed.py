...
def test_normal():
    ...
    assert embed.author.icon.url == f"attachment://{mock_author.display_avatar_url}"
...
def test_invalid_author():
    ...
    assert str(exc.value) == "Author does not have properties display_name and/or display_avatar_url."
